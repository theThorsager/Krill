...
{
    public class TensorDisplay2d : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the PostProcessing2d class.
        /// </summary>
        public TensorDisplay2d()
          : base("TensorDisplay2d", "TensorDisplay2d",
              "Description",
              "Krill", "Utility")
        {
        }
        ...
        {
            Param.PostProcessingResults2dGoo postResults = null;
            ...
            for (int i = 0; i < n * n; i++)
            {
                ...
                {
                    Point2d pt2d = post.mask.IndexToPoint(i);
        ...
        {
            get { return new Guid("6B676BD3-ED76-4763-8D4A-8990ACA8721D"); }
        }
    }
}